...
const project = new cdk.JsiiProject({
    ...
    deps: ["projen", "@nikovirtala/projen-homebrew"],
    devDeps: ["@nikovirtala/projen-vitest"],
    description: "Colima component for projen projects",
    dependabot: false,
    depsUpgradeOptions: {
        workflowOptions: {
    ...
    packageName: "@nikovirtala/projen-colima",
    peerDeps: ["projen", "constructs"],
    pnpmVersion: "10",
    projenrcTs: true,
    releaseToNpm: true,
    npmTrustedPublishing: true,
    repositoryUrl: "https://github.com/nikovirtala/projen-colima.git",
